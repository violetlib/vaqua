...
public class SingleRepresentationImage8 extends Image implements MultiResolutionImage {

    protected final Image image;
    protected final int imageWidth;
    protected final int imageHeight;

    public SingleRepresentationImage8(@NotNull BufferedImage im, int width, int height) {
        this.image = im;
